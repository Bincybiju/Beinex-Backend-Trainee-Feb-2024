...
class Cypher:
    ...
    def convert_string(cls, input_string):
        ...
        for char in input_string:
            if char.isdigit():
                ...
                if char.isupper():
                    converted_string += shifted_char.lower()
                else:
    ...
    def from_user_input(cls):
        user_input = input("Enter a string to convert: ")
        return cls(user_input)



cypher_obj = Cypher.from_user_input()

converted_string = cypher_obj.perform_conversion()
